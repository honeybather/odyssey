question_mapping = {
    "Are you seeking a sport that develops discipline and mental resilience?": {
        "yes": [
            "MMA", "Muay Thai", "Boxing", "Wrestling", "Jiu-Jitsu",
            "Basketball", "Soccer", "Volleyball", "Baseball", "Football",
            "Running", "Biking", "Swimming", "Rock Climbing", "Yoga",
            "Powerlifting", "CrossFit", "Gymnastics", "Tennis", "Triathlon"
        ],
        "no": []
    },
    "Would you like to improve your fitness and have fun while connecting with others through sports?": {
        "yes": [
            "MMA", "Muay Thai", "Boxing", "Wrestling", "Jiu-Jitsu",
            "Basketball", "Soccer", "Volleyball", "Baseball", "Football",
            "Running", "Biking", "Swimming", "Rock Climbing", "Yoga",
    ...
    "Do you want to challenge yourself and push your limits while having fun?": {
        "yes": [
            "MMA", "Muay Thai", "Boxing", "Wrestling", "Jiu-Jitsu",
            "Basketball", "Soccer", "Volleyball", "Baseball", "Football",
            "Running", "Biking", "Swimming", "Rock Climbing", "Yoga",
    ...
    "Are you interested in sports that focus on combat or self-defense skills?": {
        "yes": ["MMA", "Muay Thai", "Boxing", "Wrestling", "Jiu-Jitsu"],
        "no": ["Basketball", "Soccer", "Volleyball", "Baseball", "Football", "Running", "Biking", "Swimming", "Rock Climbing", "Yoga", "Powerlifting", "CrossFit", "Gymnastics", "Triathlon"]
    },
    "Do you prefer activities that involve strategy and problem-solving?": {
